...
var (
	...
	// Olivetum-specific errors.
	ErrContractCreationDisabled = errors.New("contract creation disabled")
	ErrSelfTransfer             = errors.New("self-transfers not allowed")
	ErrUnauthorizedManagementTx = errors.New("management transaction requires administrator")
	ErrTxDataNotAllowed         = errors.New("transaction data not allowed")
	ErrTxDataLengthInvalid      = errors.New("invalid transaction data length")
	ErrTxAccessListNotAllowed   = errors.New("transaction access list not allowed")
	ErrTxValueNotAllowed        = errors.New("transaction value not allowed")
