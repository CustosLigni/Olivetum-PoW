...
func (c *CoreGethChainConfig) GetConsensusEngineType() ctypes.ConsensusEngineT {
	if c.Olivetumhash != nil {
		return ctypes.ConsensusEngineT_Olivetumhash
	}
	if c.Ethash != nil {
...
func (c *CoreGethChainConfig) MustSetConsensusEngineType(t ctypes.ConsensusEngineT) error {
	...
	case ctypes.ConsensusEngineT_Ethash:
		...
		c.Olivetumhash = nil
		c.OlivetumhashBlock = nil
		c.Clique = nil
		c.Lyra2 = nil
		return nil
	case ctypes.ConsensusEngineT_Olivetumhash:
		c.Olivetumhash = new(ctypes.OlivetumhashConfig)
		c.Ethash = nil
		c.Clique = nil
		c.Lyra2 = nil
		return nil
...
func (c *CoreGethChainConfig) GetOlivetumhashTransition() *uint64 {
	if c.GetConsensusEngineType() != ctypes.ConsensusEngineT_Olivetumhash {
		return nil
	}
	return bigNewU64(c.OlivetumhashBlock)
}

func (c *CoreGethChainConfig) SetOlivetumhashTransition(n *uint64) error {
	if c.Olivetumhash == nil {
		return ctypes.ErrUnsupportedConfigFatal
	}
	c.OlivetumhashBlock = setBig(c.OlivetumhashBlock, n)
	return nil
}
