...
func (c ConsensusEngineT) String() string {
	...
	case ConsensusEngineT_Ethash:
		return "ethash"
	case ConsensusEngineT_Olivetumhash:
		return "olivetumhash"
...
func (c ConsensusEngineT) IsOlivetumhash() bool {
	return c == ConsensusEngineT_Olivetumhash
}
...
// OlivetumhashConfig is the consensus engine config for the Olivetum memory-hard proof-of-work.
type OlivetumhashConfig struct {
	EpochLength        uint64 `json:"epochLength"`
	DatasetInitBytes   uint64 `json:"datasetInitBytes"`
	DatasetGrowthBytes uint64 `json:"datasetGrowthBytes"`
	MixRounds          uint64 `json:"mixRounds"`
}

// String implements the stringer interface, returning the consensus engine details.
func (c *OlivetumhashConfig) String() string {
	return "olivetumhash"
}
