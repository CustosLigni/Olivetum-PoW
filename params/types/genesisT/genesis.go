...
func (g *Genesis) GetOlivetumhashTransition() *uint64 {
	return g.Config.GetOlivetumhashTransition()
}

func (g *Genesis) SetOlivetumhashTransition(n *uint64) error {
	return g.Config.SetOlivetumhashTransition(n)
}
