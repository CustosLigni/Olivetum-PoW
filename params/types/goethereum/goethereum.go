...
type ChainConfig struct {
	...
	Olivetumhash      *ctypes.OlivetumhashConfig `json:"olivetumhash,omitempty"`
	OlivetumhashBlock *big.Int                   `json:"olivetumhashBlock,omitempty"`
...
func (c *ChainConfig) String() string {
	...
	switch {
	case c.Olivetumhash != nil:
		banner += "Consensus: Olivetumhash (memory-hard proof-of-work)\n"
		if c.OlivetumhashBlock != nil {
			banner += fmt.Sprintf(" - Olivetumhash transition:       #%-8v\n", c.OlivetumhashBlock)
		}
	case c.Ethash != nil:
